...
function getIcon(icon) {
  ...
  switch (icon) {
    case "twitter":
      return (
        <FontAwesome.FaTwitterSquare alt={alt} size={"100%"} {...iconCss} />
      );
    case "facebook":
      return (
        <FontAwesome.FaFacebookSquare alt={alt} size={"100%"} {...iconCss} />
      );
    case "email":
      return (
        <FontAwesome.FaEnvelopeSquare alt={alt} size={"100%"} {...iconCss} />
      );
    case "instagram":
      return <FontAwesome.FaInstagram alt={alt} size={"100%"} {...iconCss} />;
    case "youtube":
      return <FontAwesome.FaYoutubePlay alt={alt} size={"100%"} {...iconCss} />;
    case "steam":
      return <FontAwesome.FaSteamSquare alt={alt} size={"100%"} {...iconCss} />;
    default:
      break;
  }
}
